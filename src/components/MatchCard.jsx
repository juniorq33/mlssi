...
export default function MatchCard ({assetHA, competition, homeTeam, homeTeamName, awayTeam, awayTeamName, goalsHome, goalsAway, stadium, date, goalsSummary}) {
  return (
    <div class="flex flex-col justify-center items-center rounded-lg shadow-2xl bg-white p-2">
        ...
        <div class="flex flex-row">
            <div class="flex flex-col items-center gap-2">
                ...
                <h1 class="font-sans text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">{homeTeamName}</h1>
            </div>
            ...
            <div class="flex flex-col items-center gap-2">
                ...
                <p class="font-sans text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">{awayTeamName}</p>
            </div>
